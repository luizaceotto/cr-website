    ...
    <link type="text/css" rel="stylesheet" href="fonts/font-icon/font-awesome/css/font-awesome.css">
    <link type="text/css" rel="stylesheet" href="fonts/font-icon/font-construction/flaticon.css">
    <!-- LIBRARY CSS-->
    ...
    <link type="text/css" rel="stylesheet" href="libs/fancybox/css/jquery.fancybox-thumbs.css">
    <!-- STYLE CSS-->
